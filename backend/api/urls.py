...
urlpatterns = [
    ...
    path("publisher/<int:pk>/distribute-reviews/", AdminViews.DistributeReviewsView.as_view(), name="distribute-reviews"),
    path("publisher/<int:pk>/accept-all-reviews/", AdminViews.AcceptAllReviewsView.as_view(), name="accept-all-reviews"),
    ...
    path('auth/is-staff/', UserViews.UserIsStaffView.as_view(), name='is-staff'),
