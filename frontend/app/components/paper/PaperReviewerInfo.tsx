...
import styles from "./PaperReviewerInfo.module.css";
...
import PaperReviewInvited from "./PaperReviewInvited";

interface PaperReviewerInfoProps {
  review: Review;
  reviewStatus: ReviewStatus | null;
  setReviewStatus: React.Dispatch<React.SetStateAction<ReviewStatus | null>>;
}

const PaperReviewerInfo = ({ review, reviewStatus, setReviewStatus }: PaperReviewerInfoProps) => {
  ...
  return (
    <div className={styles.container}>
      ...
      {reviewStatus == ReviewStatus.Invited &&
        <PaperReviewInvited reviewId={review.id} setReviewStatus={setReviewStatus} />
      }
...
export default PaperReviewerInfo;
